	...
	<div class="uk-block">
											...
											<c:forEach items="${Expedientes}" var="x">
												<tr>
													...
													<td><a href="#" class="uk-button"
														...
														onclick="editarExpediente('${x.idExpediente}','${x.trabajador.idTrabajador}','${x.estado}','${x.fchaApertura}');"><i
															class="uk-icon-pencil"></i></a></td>
													<td><a href="#" class="uk-button"
														onclick="eliminar('${x.idExpediente}');"><i
		...
		<div id="modal" class="uk-modal">
			<div class="uk-modal-dialog">
				...
				<div class="uk-container">
					<form class="uk-form uk-form-horizontal" action="Expediente"
						method="post">
						...
						<div class="uk-form-row">
							<label class="uk-form-label" for="fecha_ingreso">Fecha de
								Apertura</label>
							<div class="uk-form-controls">
								<input id="fecha_ingreso" type="text" name="fchApertura"
			...
			<div class="uk-modal-dialog">
				...
				<div class="uk-container">
					<form class="uk-form uk-form-horizontal" action="Expediente"
						...
						<div class="uk-form-row">
							<label class="uk-form-label" for="fecha_ingresoAct">Fecha
								de Apertura</label>
							<div class="uk-form-controls">
								<input id="fecha_ingresoAct" type="text" name="fchApertura"
									data-uk-datepicker="{format:'YYYY-MM-DD'}">
							</div>
						</div>
						<div class="uk-form-row uk-text-center">
