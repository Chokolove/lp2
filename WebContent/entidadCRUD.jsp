  ...
  <body>
    ...
    <div id="offcanvas" class="uk-offcanvas">
      <div class="uk-offcanvas-bar">
        <div class="uk-panel">
          <h3 class="uk-panel-title"> Entidad</h3>
        </div>
        <ul class="uk-nav uk-nav-offcanvas uk-nav-parent-icon" data-uk-nav>
          ...
          <li>
           ...
           <li>
            <a href="Entidad?metodo=lista&filtro=">Entidad CRUD</a>
          </li>
          <li class="uk-parent">
            <a href="#">Reportes</a>
            <ul class="uk-nav-sub">
    ...
    <div class="uk-block">
                    ...
                    <div class="uk-margin uk-margin-left">
                      ...
                      <div class="uk-margin-top">
                        <div class="uk-margin-left">
                          <button class="uk-button uk-button-large uk-button-primary" type="button" data-uk-modal="{target:'#modal'}">Nueva Entidad</button>
                        </div>
                      </div>
	                      ...
	                      <c:forEach items="${Entidad}" var="x">
	                      	<tr>
                                ...
                                <td>${x.sector}</td>
	                      		...
	                      		<td>${x.direccion}</td>
	                      		<td>
	                      			<a href="#" class="uk-button" data-uk-modal="{target:'#modal2'}" onclick="editar('${x.idEntidad}','${x.poder_est}','${x.sector}','${x.ruc}','${x.nombre}','${x.direccion}');"><i class="uk-icon-pencil"></i></a>
	                      		</td>
	                      		<td>
	                      			<a href="#" class="uk-button" onclick="eliminar('${x.idEntidad}');"><i class="uk-icon-times-circle"></i></a>
	                      		</td>
	                      	</tr>
	                      </c:forEach>
	                    </tbody>
      ...
      <div id="modal" class="uk-modal">
        <div class="uk-modal-dialog">
          ...
          <div class="uk-container">
	          <form class="uk-form uk-form-horizontal" action="Entidad"  method="post">
				...
				<div class="uk-form-row">
                    <label class="uk-form-label" for="poder_est">Poder Estatal</label>
                    <div class="uk-form-controls">
                        <input id="poder_est" type="text" name="poder_est">
          		</div>
	            <!-- <div class="uk-form-row">
	               <label class="uk-form-label" for="form-h-s">Poder Estatal</label>
	               <div class="uk-form-controls">
		               <select name ="poder_est"id="form-h-s">
		               	<c:forEach items="${Entidad}" var="x">
		                 	<option value="${x.poder_est }">${x.poder_est}</option>
		               	</c:forEach>
		               </select>
	            	</div>
	           </div>-->
