    ...
    <div class="uk-block">
                    ...
                    <div class="uk-margin uk-margin-left">
                      ...
                      <div class="uk-margin-top">
                        <div class="uk-margin-left">
                          <button class="uk-button uk-button-large uk-button-primary" type="button" data-uk-modal="{target:'#modal'}">Nuevo Empleado</button>
                        </div>
                      </div>
	                      ...
	                      <c:forEach items="${Empleado}" var="x">
	                      	<tr>
								...
								<td>${x.apeMat}</td>
	                      		...
	                      		<td>
	                      			<a href="#" class="uk-button" data-uk-modal="{target:'#modal2'}" onclick="editar('${x.idEmpleado}','${x.nombre}','${x.apePat}','${apeMat}','${x.sueldo}','${x.cargo.nombre}');"><i class="uk-icon-pencil"></i></a>
	                      		</td>
	                      		<td>
	                      			<a href="#" class="uk-button" onclick="eliminar('${x.idEmpleado}');"><i class="uk-icon-times-circle"></i></a>
	                      		</td>
	                      	</tr>
	                      </c:forEach>
	                    </tbody>
      ...
      <div id="modal" class="uk-modal">
        <div class="uk-modal-dialog">
          ...
          <div class="uk-container">
	          <form class="uk-form uk-form-horizontal" action="Empleado"  method="post">
	            ...
	            <div class="uk-form-row">
	               <label class="uk-form-label" for="form-h-s">Empleado</label>
	               <div class="uk-form-controls">
		               <select name ="idEmpleado"id="form-h-s">
		               	<c:forEach items="${Empleado}" var="x">
		                 	<option value="${x.idEmpleado }">${x.nombre }</option>
		               	</c:forEach>
		               </select>
	            	</div>
	           </div>
	           ...
	           <div class="uk-form-row">
                  <label class="uk-form-label" for="form-h-it">Apellido Paterno </label>
                     <div class="uk-form-controls">
                ...
                <div class="uk-form-row">
                  <label class="uk-form-label" for="form-h-it">Apellido Materno </label>
                     <div class="uk-form-controls">
